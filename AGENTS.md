...
- Read README.md and docs/04-开发与试玩记录.md before making changes. Read docs/07-当前游戏规则.md once it exists.
...
- Update README status and docs/04-开发与试玩记录.md in the same work session as meaningful implementation changes.
