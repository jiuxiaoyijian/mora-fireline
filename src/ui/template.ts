...
<div id="game-stage">
  <main id="game-world" aria-label="火线街区游戏">
    ...
    <header class="hud-top">
      ...
      <div class="resource-ribbon"><div id="homes-resource"><span>安置</span><strong id="homes">12 / 12</strong></div><div id="budget-resource"><span>预算</span><strong id="budget">12 点</strong></div><button id="menu-open" class="icon-button" aria-label="打开游戏菜单">☰</button></div>
    </header>
    <div class="wind-label">山火来向　西 → 东</div>
    ...
    <div id="warning-overlay" class="warning-overlay" hidden><span class="eyebrow">防线演练即将开始</span><strong>山火自西侧逼近</strong><p>西 → 东</p><b id="warning-count">3</b></div>
    ...
    <div class="build-dock">
      ...
      <div class="dock-main"><div class="tools" role="group" aria-label="建造工具">
        <button data-tool="house" class="tool" aria-pressed="false">${svg("house")}<span><b>住宅</b><small>可搬迁</small></span><kbd>1</kbd></button>
        ...
        <button id="undo" aria-label="撤销上一步" disabled>↶</button><button id="cancel-move" hidden>取消搬迁</button>
  ...
  <dialog id="mission-dialog" aria-labelledby="mission-heading"><button id="mission-close" class="dialog-close" aria-label="关闭委托">×</button><span class="eyebrow">松风镇巡护站 · 第 01 号委托</span><h2 id="mission-heading">让家园等到他们回来</h2><p>你是镇上的防灾规划员。居民已撤离，请用 12 点预算规划防线，为返乡保住家园。</p><div class="mission-targets"><span><b>8 户</b>最低目标</span><span><b>12 户</b>完整守护</span></div><p id="mission-status"></p><div id="insight" class="insight"></div></dialog>
