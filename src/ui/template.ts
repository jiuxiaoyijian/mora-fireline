...
<div id="game-stage">
  <main id="game-world" aria-label="火线街区游戏">
    ...
    <div class="wind-label"><strong id="wind-current"></strong><small id="weather-plan"></small></div><aside class="lesson-card"><strong id="lesson-title"></strong><p id="lesson-text"></p><div><button id="hint-open">巡护提示</button><small id="lesson-progress">先读委托，观察火源，再布置防线。</small></div><p id="lesson-hint" hidden></p></aside><div id="water-pressure" class="water-pressure" aria-label="喷淋拦截储备" hidden></div><div id="fire-feedback" class="fire-feedback" role="status" hidden></div>
